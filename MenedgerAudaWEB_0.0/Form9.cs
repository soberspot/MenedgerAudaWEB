...
namespace MenedgerAudaWEB_0._0
{
    public partial class Form9 : Form
    {
        ...
        public Form9()
        {
            ...
            pathTextBox.Text = @"C:\AUDATEX\offinout\Формулы.dotx";

            //только для теста: явное значение возраста
            oldkuzovtextBox.Text = oldplastic_textBox.Text  = "4";
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "базаАнатолийDataSet11.База_ИП". При необходимости она может быть перемещена или удалена.
            this.база_ИПTableAdapter.Fill(this.базаАнатолийDataSet11.База_ИП);
        ...
        private void заполнитьTextBoxs_из_dataGridView1()
        {
            ...
            dataprod_textBox.Text = dataGridView1.CurrentRow.Cells[6].Value.ToString();  // дата выпуска
        ...
        private void ПересчетВозраста()
        {
            ...
            oldAKB_textBox.Text = oldkuzovtextBox.Text = oldplastic_textBox.Text = olddetal_textBox.Text = _age.ToString();
        }
        ...
        private void Расчет_Износа()
        {
            ...
            iznosDet_textBox.Text = Iznos.ИзносДеталей(dttextBox.Text, oldkuzovtextBox.Text, dl_textBox.Text, probeg_textBox.Text);
        ...
        private void export_toWordFormula_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                wordDoc.ReplaceAllStrings("{@@КАТ}", comboBox2.Text);
        ...
        private void inFormulaWord_Click(object sender, EventArgs e)
        {
            WordDocument wordDoc = null;
            try
            {
